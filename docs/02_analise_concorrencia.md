...
|---|---|---|---|---|
| Google Sala de Aula (Classroom) | Centraliza aulas, materiais, atividades e comunicação. Cria turmas, compartilha arquivos, define prazos, aplica trabalhos e dá feedback. Integra-se ao Drive, Docs, Planilhas e Meet. | Centralização, simplicidade, navegação intuitiva, integração com ecossistema. |`assets/02_concorrencia/googleClassroom-inicio.jpeg`, `assets/02_concorrencia/googleClassroo
